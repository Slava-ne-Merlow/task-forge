...
import "./chunk-QKH4DEBI.js";
import "./chunk-5BFNCQHW.js";
import "./chunk-SF3OYYYP.js";
import "./chunk-KW6GQPFI.js";
import {
  NgTemplateOutlet
} from "./chunk-BTOGBD7R.js";
import "./chunk-ZALAKCAB.js";
import {
...
function TuiCarouselComponent_Conditional_2_ng_container_1_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵelementContainer(0);
  }
}
function TuiCarouselComponent_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵelementStart(0, "span", 2);
    ɵɵtemplate(1, TuiCarouselComponent_Conditional_2_ng_container_1_Template, 1, 0, "ng-container", 1);
    ɵɵelementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = ɵɵnextContext();
    ɵɵadvance();
    ɵɵproperty("ngTemplateOutlet", ctx_r0.template())("ngTemplateOutletContext", ɵɵpureFunction1(2, _c0, ctx_r0.index()));
  }
}
function TuiCarouselComponent_ng_container_4_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵelementContainer(0);
  }
}
var TuiCarouselComponent = class _TuiCarouselComponent {
  ...
  static {
    this.ɵcmp = ɵɵdefineComponent({
      ...
      hostAttrs: ["waIntersectionThreshold", "1"],
      inputs: {
        index: [1, "index"],
        min: [1, "min"],
        max: [1, "max"]
      ...
      decls: 5,
      vars: 9,
      consts: [[1, "t-item", 3, "waIntersectionObservee"], [4, "ngTemplateOutlet", "ngTemplateOutletContext"], [1, "t-item"]],
      template: function TuiCarouselComponent_Template(rf, ctx) {
        if (rf & 1) {
          ɵɵelementStart(0, "span", 0);
          ɵɵlistener("waIntersectionObservee", function TuiCarouselComponent_Template_span_waIntersectionObservee_0_listener($event) {
          ...
          ɵɵelementEnd();
          ɵɵconditionalCreate(2, TuiCarouselComponent_Conditional_2_Template, 2, 4, "span", 2);
          ...
          ɵɵtemplate(4, TuiCarouselComponent_ng_container_4_Template, 1, 0, "ng-container", 1);
          ɵɵelementEnd();
        }
        if (rf & 2) {
          ɵɵadvance();
          ɵɵproperty("ngTemplateOutlet", ctx.template())("ngTemplateOutletContext", ɵɵpureFunction1(5, _c0, ctx.math.max(ctx.index() - 1, ctx.min())));
          ɵɵadvance();
          ɵɵconditional(ctx.index() !== ctx.min() && ctx.index() !== ctx.max() ? 2 : -1);
          ɵɵadvance(2);
          ɵɵproperty("ngTemplateOutlet", ctx.template())("ngTemplateOutletContext", ɵɵpureFunction1(7, _c0, ctx.math.min(ctx.index() + 1, ctx.max())));
        }
      },
      dependencies: [NgTemplateOutlet, WaIntersectionObservee],
      styles: ["[_nghost-%COMP%]{scrollbar-width:none;-ms-overflow-style:none;display:flex;max-inline-size:100%;overscroll-behavior:none;overflow-x:scroll;overflow-y:hidden;scroll-snap-type:x mandatory}[_nghost-%COMP%]::-webkit-scrollbar, [_nghost-%COMP%]::-webkit-scrollbar-thumb{display:none}[_nghost-%COMP%]:active   .t-item[_ngcontent-%COMP%]{padding-block-start:1px;margin-block-start:-1px}.t-item[_ngcontent-%COMP%]{position:relative;display:flex;min-inline-size:100%;block-size:100%;box-sizing:content-box;align-items:center;justify-content:center;scroll-snap-align:start;scroll-snap-stop:always}"],
      changeDetection: 0
    });
  }
};
